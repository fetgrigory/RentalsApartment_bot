...
- Администратор может просматривать полученные заявки на бронирование и просматривать отзывы клиентов. Классификация отзывов происходит при помощи модели:blanchefort/rubert-base-cased-sentiment
