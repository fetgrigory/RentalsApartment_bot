...
**Telegram-платформа для аренды квартир** с доменно-ориентированной моделью данных и интеллектуальной обработкой пользовательских запросов.

Проект реализует полный цикл работы с объектами недвижимости от структурированного ввода и хранения данных до поиска, бронирования и интеллектуального ответа на вопросы пользователей.
...
Проект построен вокруг разделения ролей **администратора** и **пользователя**, с централизованным хранилищем данных и отдельными компонентами для:
```mermaid
graph TD
