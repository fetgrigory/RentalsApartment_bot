...
## Использование SQLite и PostgreSQL в системе аренды квартир

В проекте системы аренды квартир использование двух типов баз данных — SQLite и PostgreSQL — позволяет гибко адаптироваться к различным требованиям разработки и эксплуатации. 
...
**Преимущества PostgreSQL перед SQLite для системы аренды квартир:**
