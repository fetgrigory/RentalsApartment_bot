...
1. Необходимо заполнить значения в файле ".env"
Для получения TOKEN и PAYMENTS_TOKEN нужно вызвать бота @BotFather
Для получения ADMIN_ID нужно вызвать бота @getmyid_bot
2. Запустите бота при помощи команнды "python main.py" 
