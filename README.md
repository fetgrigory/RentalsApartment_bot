...
- [Аналитика отзывов с RuBERT](#аналитика-отзывов-с-rubert)
...
Бот использует модель [**blanchefort/rubert-base-cased-sentiment**](https://huggingface.co/blanchefort/rubert-base-cased-sentiment)  
для анализа пользовательских отзывов и автоматической классификации их по тональности.
