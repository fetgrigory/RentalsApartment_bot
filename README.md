...
**Telegram-бот для аренды квартир**. Проект реализует полный цикл работы с объектами недвижимости: структурированный ввод данных, хранение, поиск и бронирование квартир.
